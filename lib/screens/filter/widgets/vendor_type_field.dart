          ...
          children: <Widget>[
            GestureDetector(
              ...
              child: Container(
                ...
                child: Text('Particular', style: TextStyle(color: state.value & VENDOR_TYPE_PARTICULAR != 0?Colors.white:Colors.black)),
              ),
            ),
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    color: state.value & VENDOR_TYPE_PROFESSIONAL != 0
                        ...
                        : Colors.transparent),
                alignment: Alignment.center,
                child: Text('Profissional', style: TextStyle(color: state.value & VENDOR_TYPE_PROFESSIONAL != 0?Colors.white:Colors.black)),
              ),
            )
          ],
        );
